...
import { touchDpad, touchButton } from "./touch.js";
...
export const LIBRARY_UI_RUNTIME_TYPES = ["hud-bar", "touch-dpad", "touch-button"] as const;
...
export { touchDpad, touchButton, dpadVector, buttonPressed, type PointerLike, type Zone, type Rect } from "./touch.js";
