...
// App's webhook URL). This forwards that channel to the local webhook
...
if (!env.webhookProxyUrl) {
  console.error("WEBHOOK_PROXY_URL is not set in .env — create a smee.io channel and set it.");
  process.exit(1);
}
